...
<body >
   ...
   <!-- <header id="header" class="row">    -->
   		...
   		<!-- <div class="header-logo">
	        <a href="index.html">SteawardApp</a>
	    </div> -->
			...
			<ul class="header-main-nav">
             ...
             @if (Route::has('login'))
                <div class="header-main-nav">
                    ...
                    @else
                    <a href="{{ route('login') }}" title="sign-up" class="button button-primary cta">Log in</a>
                    <a href="{{ route('register') }}" title="sign-up" class="button button-primary cta">Sign Up</a>
                        <!-- <a href="{{ route('login') }}" title="sign-up" class="button button-primary cta">Login</a>
        ...
        <div class="home-content">        
            ...
            <div class="row contents">                     
                <div class="home-content-left">
                    ...
                    <h3 data-aos="fade-up">Welcome to StaffApp</h3>

                    <h1 data-aos="fade-up">
                        This App will<br>
                        help you find<br>
                        work at events in Milan
                    </h1>
